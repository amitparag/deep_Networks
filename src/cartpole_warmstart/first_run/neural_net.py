...
def train_net(n_hidden: int = 4, traj:int = 1000,
    ...
    x_test, y_test = get_trajectories(500) 
...
if __name__=='__main__':
    ...
    # Spawn 50 processes
    for _ in range(50):
        process = Process(target=train_net, args = (5, 2000, True,False, True))
        #square(number)
    ...
    for process in processes:
        process.join()
    """
    train_net(5, 1000,True,False, True)
